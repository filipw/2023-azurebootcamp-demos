...
entry:
  ...
  call void @Microsoft__Quantum__Canon___6d3317eafe454707b94e49f2a61972d5_ApplyToEach__body(%Callable* %0, %Array* %qubits)
...
define internal void @Microsoft__Quantum__Canon___6d3317eafe454707b94e49f2a61972d5_ApplyToEach__body(%Callable* %singleElementOperation, %Array* %register) {
entry:
  ...
  %0 = call %Range @Microsoft__Quantum__Arrays___9dcc005b173c440dade6b8aa5fa829f1_IndexRange__body(%Array* %register)
...
entry:
  ...
  %1 = call %Array* @Microsoft__Quantum__Arrays___61bae488b41f45b78ed98fbed5668909_ForEach__body(%Callable* %0, %Array* %targets)
  call void @__quantum__rt__array_update_alias_count(%Array* %targets, i32 -1)
  call void @__quantum__rt__capture_update_reference_count(%Callable* %0, i32 -1)
  call void @__quantum__rt__callable_update_reference_count(%Callable* %0, i32 -1)
  ret %Array* %1
...
define internal %Array* @Microsoft__Quantum__Arrays___61bae488b41f45b78ed98fbed5668909_ForEach__body(%Callable* %action, %Array* %array) {
entry:
...
define internal %Range @Microsoft__Quantum__Arrays___9dcc005b173c440dade6b8aa5fa829f1_IndexRange__body(%Array* %array) {
entry:
  call void @__quantum__rt__array_update_alias_count(%Array* %array, i32 1)
...
define internal %Array* @Microsoft__Quantum__Arrays___7902e8404d344f7992cdb8d84f1f8146_Mapped__body(%Callable* %mapper, %Array* %array) {
entry:
  %retval = alloca %Array*, align 8
...
entry:
  ...
  %1 = call %Array* @Microsoft__Quantum__Arrays___7902e8404d344f7992cdb8d84f1f8146_Mapped__body(%Callable* %0, %Array* %input)
  call void @__quantum__rt__array_update_alias_count(%Array* %input, i32 -1)
  call void @__quantum__rt__capture_update_reference_count(%Callable* %0, i32 -1)
  call void @__quantum__rt__callable_update_reference_count(%Callable* %0, i32 -1)
  ret %Array* %1
