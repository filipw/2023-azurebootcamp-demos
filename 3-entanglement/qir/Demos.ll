...
entry:
  ...
  %resultControl = call %Result* @Microsoft__Quantum__Intrinsic__M__body(%Qubit* %control)
  %resultTarget = call %Result* @Microsoft__Quantum__Intrinsic__M__body(%Qubit* %target)
  call void @__quantum__rt__result_update_reference_count(%Result* %resultControl, i32 1)
  call void @__quantum__rt__result_update_reference_count(%Result* %resultTarget, i32 1)
  %0 = call %Tuple* @__quantum__rt__tuple_create(i64 ptrtoint ({ %Result*, %Result* }* getelementptr ({ %Result*, %Result* }, { %Result*, %Result* }* null, i32 1) to i64))
  %1 = bitcast %Tuple* %0 to { %Result*, %Result* }*
  %2 = getelementptr inbounds { %Result*, %Result* }, { %Result*, %Result* }* %1, i32 0, i32 0
  %3 = getelementptr inbounds { %Result*, %Result* }, { %Result*, %Result* }* %1, i32 0, i32 1
  store %Result* %resultControl, %Result** %2, align 8
  store %Result* %resultTarget, %Result** %3, align 8
  call void @__quantum__rt__result_update_reference_count(%Result* %resultControl, i32 -1)
  call void @__quantum__rt__result_update_reference_count(%Result* %resultTarget, i32 -1)
